...
def get_reviews(tree):
    print tree.xpath('//div[@id="EmployerReviews"]//li[contains(@class, "empReview")]')
...
def get_all_reviews(tree, company, max_pages = 100):
...
def get_all_company_reviews(companies_list,  max_pages = 100):
    visited_companies = []
    failed_companies = []
    ...
    for company in companies_list:
        ...
        try:
            ...
            if tree:
                get_all_reviews(tree, company, max_pages)
    ...
    print visited_companies
    print failed_companies
    return visited_companies, failed_companies


companies_list = [u'Amazon','Google']
get_all_company_reviews(companies_list,1)
